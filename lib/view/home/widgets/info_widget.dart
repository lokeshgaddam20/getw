...
import 'package:getw/res/images/image_assets.dart';
import 'package:getw/view/home/widgets/components/horizontal_container.dart';
import 'package:getw/view/home/widgets/components/info_row.dart';
import 'package:getw/view/home/widgets/components/vertical_container.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    InfoRow(
                        label: 'Pressure', value: globalController.pressure()),
                    InfoRow(
                        label: 'Humidity', value: globalController.humidity()),
                    InfoRow(
                        label: 'Visibility',
